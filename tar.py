...
꧁⚛️⚛️⚛️⚛️ Command Groups ⚛️⚛️⚛️⚛️꧂
...
🔰 [invite:「mid」]
🔰 [Cname,2Cn,1Hy 「name」]
🔰 [Gift] [All gift] [Me gift][Ginf30]
🔰 [Respon]
🔰 [Cancel1]
🔰 [Title:]
🔰 [[J.Days]]

✯⚛️⚛️⚛️⚛⚛️⚛️⚛️ ️️ ꧁ Creator ꧂ ⚛️⚛️⚛️⚛️⚛️⚛️⚛️✯

✯☣️☣️☣️☣️☣️☣️ ⋆⋆[⏭ ️J.Days ⏮️]⋆⋆ ☣️☣️☣️☣️☣️☣️✯
"""
KAC=[cl,ki,kk,kc,ky]
...
admin=["uf66f73f5393a7eccb707f59183ce9625"]
wait = {
    'contact':True,
    'autoJoin':True,
              ...
              if msg.toType == 2:
                ...
                if wait["clock"] == True:
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "An already read point has not been set.\n「Day Set」you can send ♪ read point will be created ♪")
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    f=codecs.open('st2__b.json','w','utf-8')
                                    json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                    ki.sendText(msg.to,"Day Ban Done🔥 ")
                                except:
...
#-----------------------------------------------
            elif msg.text in ["#Test","Respon"]:              
                ki.sendText(msg.to,"Ok J.Days🔰")
                kk.sendText(msg.to,"Day bot🔰")
                ki.sendText(msg.to,"Ok J.Days🔰")
                kk.sendText(msg.to,"Day bot🔰")
                ki.sendText(msg.to,"Ok J.Days🔰")
                kk.sendText(msg.to,"Day bot🔰")
...
#------------------------------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    for tag in wait["blacklist"]:
                        matched_list+=filter(lambda str: str == tag, gMembMids)
                    if matched_list == []:
                        cl.sendText(msg.to,"ไม่มีผู้ใช้ใน บช.ดำ📖")
                        ki.sendText(msg.to,"ไม่มีผู้ใช้ใน บช.ดำ📖")
                        kk.sendText(msg.to,"ไม่มีผู้ใช้ใน บช.ดำ📖")
