...
#---------------------------------------------------------
                ...
                if wait["contact"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ปิดแล้ว ô€œô€„‰⛔")
                    else:
                ...
                if wait["protect"] == True:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"มันเปิดอยู่แล้ว ô€¨🌀")
                else:
                    wait["protect"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"เปิดแล้ว 🌀")
              ...
              if msg.from_ in admin:
                ...
                if wait["autoJoin"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Auto Join ปิดแล้ว ⛔")
                    else:
                        cl.sendText(msg.to,"Auto Join ถูกปิด ⛔")
                else:
                    wait["autoJoin"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ปิดแล้ว ⛔")
                    else:
                        cl.sendText(msg.to,"มันปิดอยู่แล้ว ô€œ⛔")
            elif msg.text in ["Protect off"]:
                if wait["protect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"การป้องกันถูกปิด ô€œ⛔")
                    else:
                        cl.sendText(msg.to,"มันปิดอยู่แล้ว ô€œô€„‰⛔")
                else:
                    wait["protect"] = False
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"มันถูกปิดอยู่แล้ว ô€œ⛔")
            elif msg.text in ["Qrprotect off","qrprotect off"]:
                if wait["linkprotect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ป้องกันลิ้งค์ ปิด ô€œ⛔")
                    else:
                        cl.sendText(msg.to,"มันปิดอยู่แล้ว ô€œô€„‰⛔")
                else:
                    wait["linkprotect"] = False
                ...
                if wait["inviteprotect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"กันเชิญ ปิด ô€œ⛔")
                    else:
                        cl.sendText(msg.to,"มันปิดอยู่แล้ว ô€œô€„‰⛔")
                else:
                    wait["inviteprotect"] = False
                ...
                if wait["cancelprotect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"กันยกเชิญ ปิด ô€œ⛔")
                    else:
                        cl.sendText(msg.to,"มันปิดอยู่แล้ว ô€œô€„‰⛔")
                else:
                    wait["cancelprotect"] = False
                ...
                if wait["leaveRoom"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"กลับอัตโนมัต เปิด 🌀􀜁􀇔􏿿")
                    else:
                        cl.sendText(msg.to,"มันเปิดแล้ว 🌀􀜁􀇔􏿿")
                else:
                    wait["leaveRoom"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"สำเร็จ 🌀􀜁􀇔􏿿")
                    else:
                        cl.sendText(msg.to,"มันเปิดแล้ว 🌀􀜁􀇔􏿿")
                ...
                if wait["leaveRoom"] == False:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"กลับอัตโนมัต ปิด ⛔􀜁􀇔􏿿")
                else:
                    wait["leaveRoom"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"สำเร็จ ⛔􀜁􀇔􏿿")
                    else:
                        cl.sendText(msg.to,"มันปิดอยู่แล้ว ⛔􀜁􀇔􏿿")
                ...
                if albums != []:
                    for album in albums:
                        ...
                        i += 1
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,str(i) + "อัลบั้มถูกบแล้ว 🌀")
                else:
                ...
                for i in gid:
                    ...
                    ki6.leaveGroup(i)                    
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"บอททั้งหมดออกจากกลุ่ม...")
                else:
                    cl.sendText(msg.to,"เขาปฎิเสธคำเชิญทั้งหมด...")
                ...
                if wait["autoAdd"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ปิดรับเพื่อนอัตโนมัตแล้ว ⛔")
                    else:
                        cl.sendText(msg.to,"ปิดรับเพื่อนอัตโนมัตแล้ว ⛔")
                else:
                    wait["autoAdd"] = False
                ...
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"เราเปลี่ยนข้อความต้อนรับ 🌀")
                else:
                ...
                if wait["lang"] =="JP":
                    wait["lang"] = "TW"
                    cl.sendText(msg.to,"ฉันเปลี่ยนภาษาเป็นภาษาอังกฤษ 🌐")
                else:
                    wait["lang"] = "JP"
                    cl.sendText(msg.to,"ฉันเปลี่ยนภาษาเป็นภาษาอินโดนีเซีย🌐")
            elif "Message set" in msg.text:
                ...
                if wait["commentOn"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"คอมเม้นท์ เปิด 🌀")
                    else:
                        cl.sendText(msg.to,"คอมเม้นท์ เปิด 🌀")
                else:
                    wait["commentOn"] = True
                ...
                if wait["commentOn"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"คอมเม้นท์ ปิด ⛔")
                    else:
                        cl.sendText(msg.to,"คอมเม้นท์ ปิด ⛔")
                else:
                ...
                cl.sendText(msg.to,"ขณะนี้มีการตั้งค่าความคิดเห็นโดยอัตโนมัติดังนี้: \n\n" + str(wait["comment"]))
...
#-----------------------[Add Staff Section]------------------------
                ...
                if msg.from_ in admin:
                    print "[Command]Staff remove executing"
                    _name = msg.text.replace("ลบ staff @","")
                    _nametarget = _name.rstrip('  ')
                    gs = cl.getGroup(msg.to)
                    gs = ki.getGroup(msg.to)
                    gs = ki2.getGroup(msg.to)
 ...
 #------------------------------------------------------------------
              ...
              if msg.toType == 2:
                ...
                try:
                    ...
                    cl.sendText(msg.to,name + "เราสร้างอัลบั้ม 🌀")
                except:
                    cl.sendText(msg.to,"ผิดพลาด ⛔")
...
#-----------------------------------------------
                ...
                cl.sendText(msg.to,"เจ้าของกลุ่มนี้😉" + str(ginfo.name) + " :\n" + ginfo.creator.displayName )
...
#			    random.choice(KAK).kickoutFromGroup(op.param1,[op.param2])
		    ...
		    random.choice(KAC).sendText(op.param1,"😊สวัสดีครับ😊 ยินดีต้อนรับครับ😊")
	    else:
		pass
	if op.type == 19:
	    if op.param2 not in Bots:
